...
- Do NOT include internal analysis, draft notes, approval instructions, reasoning, or markdown headers.
...
- Do NOT include internal notes, reasoning, or markdown headers.
